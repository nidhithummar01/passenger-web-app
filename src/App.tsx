...
import { SMSJourneyProvider } from './context/SMSJourneyContext';
...
import { SMSJourneyPanel } from './components/SMSJourneyPanel';
import { SMSToastContainer } from './components/SMSToast';
import { SMSIframeOverlay } from './components/SMSIframeOverlay';
    ...
    <AppProvider>
      <SMSJourneyProvider>
        <BrowserRouter>
          ...
          {/* SMS Journey — always on top, all pages */}
          <SMSToastContainer />
          <SMSIframeOverlay />
          <SMSJourneyPanel />
        </BrowserRouter>
